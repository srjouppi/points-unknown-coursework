...
map.on("load", function () {
  map.addLayer(
    {
      id: "us_states_protests_outline",
      type: "line",
      source: {
        type: "geojson",
        data: "data/statespoliceData.geojson",
      },
      paint: {
        "line-color": "#ffffff",
        "line-width": 0.7,
  ...
  map.addLayer(
    {
      id: "us_states_protests",
      type: "fill",
      source: {
        type: "geojson",
        data: "data/statepoliceData.geojson",
      },
      maxzoom: 5,
      paint: {
        // "fill-color":"grey",
        "fill-color":{
                property: 'encounters',
                stops: [[0,'#333'],[1,'#E6CCD8'],[60, '#E02916'],[200,'#61120A']]
              },
        "fill-outline-color": "#999",
      },
    },
    "waterway-label"
  //  "us_states_protests_outline" // Here's where we tell Mapbox where to slot this new layer
  );

  map.addLayer({
    id: "us_counties_protests",
    type: "fill",
    source: {
      type: "geojson",
      data: "data/protestsCounties.geojson",
    },
    minzoom:5,
    paint: {
      "fill-color":{
        property: 'NUMPOINTS',
        stops: [[0,'#333'],[1,'#E6CCD8'],[40, '#E0006C'],[100,'#61002F']]
      },
      // "fill-opacity": [
      //   "step",
      //       ["get", "NUMPOINTS"],
