...
gradCyl.on('click', 'us_counties_centroids', function (e) {
...
gradCyl.on('mouseenter', 'us_counties_centroids', function () {
    gradCyl.getCanvas().style.cursor = 'pointer';
});
gradCyl.on('mouseleave', 'us_counties_centroids', function () {
    gradCyl.getCanvas().style.cursor = '';
});
